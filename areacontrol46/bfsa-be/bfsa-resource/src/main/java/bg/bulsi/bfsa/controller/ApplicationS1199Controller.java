...
import bg.bulsi.bfsa.service.ApplicationS1199Service;
...
@Slf4j
@RestController
@RequestMapping("/s1199-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS1199Controller {

    private final ApplicationS1199Service service;
