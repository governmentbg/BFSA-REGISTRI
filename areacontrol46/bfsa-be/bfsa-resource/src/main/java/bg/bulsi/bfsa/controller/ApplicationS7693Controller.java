...
import bg.bulsi.bfsa.service.ApplicationS7693Service;
...
@Slf4j
@RestController
@RequestMapping("/s7693-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS7693Controller {

    private final ApplicationS7693Service service;
    ...
    public ResponseEntity<?> register(@RequestBody final ApplicationS7693DTO dto,
                                      @RequestHeader(HttpHeaders.ACCEPT_LANGUAGE) final Locale locale) {
        Language language = LocaleUtil.getLanguage(locale, languageService);
