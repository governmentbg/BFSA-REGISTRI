...
import bg.bulsi.bfsa.service.ApplicationS3362Service;
...
@Slf4j
@RestController
@RequestMapping("/s3362-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS3362Controller {

    private final ApplicationS3362Service service;
    ...
    public ResponseEntity<?> register(@RequestBody final ApplicationS3362DTO dto,
                                      @RequestHeader(HttpHeaders.ACCEPT_LANGUAGE) final Locale locale) {
        Language language = LocaleUtil.getLanguage(locale, languageService);
