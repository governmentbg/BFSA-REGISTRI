...
import bg.bulsi.bfsa.service.ApplicationS3201Service;
...
@Slf4j
@RestController
@RequestMapping("/s3201-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS3201Controller {

    private final ApplicationS3201Service service;
