...
import bg.bulsi.bfsa.service.ApplicationS3125Service;
...
@Slf4j
@RestController
@RequestMapping("/s3125-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS3125Controller {

    private final ApplicationS3125Service service;
