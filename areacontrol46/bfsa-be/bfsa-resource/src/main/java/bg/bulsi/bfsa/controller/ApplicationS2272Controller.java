...
@Slf4j
@RestController
@RequestMapping("/s2272-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS2272Controller {

    private final ApplicationS2272Service service;
    ...
    public ResponseEntity<?> register(@RequestBody final ApplicationS2272DTO dto,
                                      @RequestHeader(HttpHeaders.ACCEPT_LANGUAGE) final Locale locale) {
        Language language = LocaleUtil.getLanguage(locale, languageService);
