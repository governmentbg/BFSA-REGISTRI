...
import bg.bulsi.bfsa.service.ApplicationS7691Service;
...
@Slf4j
@RestController
@RequestMapping("/s7691-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS7691Controller {

    private final ApplicationS7691Service service;
    ...
    public ResponseEntity<?> register(@RequestBody final ApplicationS7691DTO dto,
                                      @RequestHeader(HttpHeaders.ACCEPT_LANGUAGE) final Locale locale) {
        Language language = LocaleUtil.getLanguage(locale, languageService);
    ...
    public ResponseEntity<?> approve(@PathVariable final Long recordId,
        ...
        Record record = service.approve(recordId, approvedFoodTypes);
