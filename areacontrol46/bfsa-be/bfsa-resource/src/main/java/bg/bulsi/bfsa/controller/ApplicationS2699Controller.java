...
import bg.bulsi.bfsa.service.ApplicationS2699Service;
...
@Slf4j
@RestController
@RequestMapping("/s2699-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS2699Controller {

    private final ApplicationS2699Service service;
    ...
    public ResponseEntity<?> register(@RequestBody final ApplicationS2699DTO dto,
                                      @RequestHeader(HttpHeaders.ACCEPT_LANGUAGE) final Locale locale) {
        Language language = LocaleUtil.getLanguage(locale, languageService);
