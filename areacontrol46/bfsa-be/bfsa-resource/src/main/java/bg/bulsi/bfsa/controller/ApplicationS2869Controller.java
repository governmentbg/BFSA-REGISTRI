...
import bg.bulsi.bfsa.service.ApplicationS2869Service;
...
@Slf4j
@RestController
@RequestMapping("/s2869-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS2869Controller {

    private final ApplicationS2869Service service;
...
//    public ResponseEntity<?> register(@RequestBody final ApplicationS2869DTO dto,
//                                      @RequestHeader(HttpHeaders.ACCEPT_LANGUAGE) final Locale locale) {
//        Language language = LocaleUtil.getLanguage(locale, languageService);
