...
import bg.bulsi.bfsa.service.ApplicationS2695Service;
...
@Slf4j
@RestController
@RequestMapping("/s2695-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS2695Controller {

    private final ApplicationS2695Service service;
    ...
    public ResponseEntity<?> register(@RequestBody final ApplicationS2695DTO dto,
                                      @RequestHeader(HttpHeaders.ACCEPT_LANGUAGE) final Locale locale) {
        Language language = LocaleUtil.getLanguage(locale, languageService);
