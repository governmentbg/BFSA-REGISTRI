...
import bg.bulsi.bfsa.service.ApplicationS2697Service;
...
@Slf4j
@RestController
@RequestMapping("/s2697-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS2697Controller {

    private final ApplicationS2697Service service;
