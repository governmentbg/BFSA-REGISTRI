...
import bg.bulsi.bfsa.service.ApplicationS7692Service;
...
@Slf4j
@RestController
@RequestMapping("/s7692-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS7692Controller {

    private final ApplicationS7692Service service;
    ...
    public ResponseEntity<?> register(@RequestBody final ApplicationS7692DTO dto,
                                      @RequestHeader(HttpHeaders.ACCEPT_LANGUAGE) final Locale locale) {
        Language language = LocaleUtil.getLanguage(locale, languageService);
    ...
    public ResponseEntity<?> approve(@PathVariable final Long recordId,
                                     @RequestBody final Set<KeyValueDTO> approvedFoodTypes,
                                     @RequestHeader(HttpHeaders.ACCEPT_LANGUAGE) final Locale locale) {
        Language language = LocaleUtil.getLanguage(locale, languageService);
