...
import bg.bulsi.bfsa.service.ApplicationS503Service;
...
@Slf4j
@RestController
@RequestMapping("/s503-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS503Controller {

    private final ApplicationS503Service service;
    ...
    public ResponseEntity<?> register(@RequestBody final ApplicationS503DTO dto,
                                      @RequestHeader(HttpHeaders.ACCEPT_LANGUAGE) final Locale locale) {
        Language language = LocaleUtil.getLanguage(locale, languageService);
