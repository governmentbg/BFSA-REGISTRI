...
import bg.bulsi.bfsa.service.ApplicationS1590Service;
...
@Slf4j
@RestController
@RequestMapping("/s1590-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS1590Controller {

    private final ApplicationS1590Service service;
    ...
    public ResponseEntity<?> register(@RequestBody final ApplicationS1590DTO dto,
                                      @RequestHeader(HttpHeaders.ACCEPT_LANGUAGE) final Locale locale) {
        Language language = LocaleUtil.getLanguage(locale, languageService);
