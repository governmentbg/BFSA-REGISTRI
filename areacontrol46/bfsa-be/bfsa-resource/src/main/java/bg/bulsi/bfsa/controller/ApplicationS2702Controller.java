...
import bg.bulsi.bfsa.service.ApplicationS2702Service;
...
@Slf4j
@RestController
@RequestMapping("/s2702-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS2702Controller {
    private final ApplicationS2702Service service;
...
//    }
    ...
    public ResponseEntity<?> register(@RequestBody final ApplicationS2702DTO dto,
                                      @RequestHeader(HttpHeaders.ACCEPT_LANGUAGE) final Locale locale
    ) {
        Language language = LocaleUtil.getLanguage(locale, languageService);
