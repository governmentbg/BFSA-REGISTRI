...
import bg.bulsi.bfsa.service.ApplicationS7696Service;
...
@Slf4j
@RestController
@RequestMapping("/s7696-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS7696Controller {

    private final ApplicationS7696Service service;
    ...
    public ResponseEntity<?> register(@RequestBody final ApplicationS7696DTO dto,
                                      @RequestHeader(HttpHeaders.ACCEPT_LANGUAGE) final Locale locale) {
        Language language = LocaleUtil.getLanguage(locale, languageService);
