...
import bg.bulsi.bfsa.service.ApplicationS2698Service;
...
@Slf4j
@RestController
@RequestMapping("/s2698-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS2698Controller {

    private final ApplicationS2698Service service;
    ...
    public ResponseEntity<?> register(@RequestBody final ApplicationS2698DTO dto,
                                      @RequestHeader(HttpHeaders.ACCEPT_LANGUAGE) final Locale locale) {
        Language language = LocaleUtil.getLanguage(locale, languageService);
