...
import bg.bulsi.bfsa.service.ApplicationS7694Service;
...
@Slf4j
@RestController
@RequestMapping("/s7694-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS7694Controller {

    private final ApplicationS7694Service service;
    ...
    public ResponseEntity<?> register(@RequestBody final ApplicationS7694DTO dto,
                                      @RequestHeader(HttpHeaders.ACCEPT_LANGUAGE) final Locale locale) {
        Language language = LocaleUtil.getLanguage(locale, languageService);
