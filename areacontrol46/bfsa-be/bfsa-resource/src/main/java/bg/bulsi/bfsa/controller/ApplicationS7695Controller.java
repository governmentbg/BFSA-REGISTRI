...
import bg.bulsi.bfsa.service.ApplicationS7695Service;
...
@Slf4j
@RestController
@RequestMapping("/s7695-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS7695Controller {

    private final ApplicationS7695Service service;
    ...
    public ResponseEntity<?> register(@RequestBody final ApplicationS7695DTO dto,
                                      @RequestHeader(HttpHeaders.ACCEPT_LANGUAGE) final Locale locale) {
        Language language = LocaleUtil.getLanguage(locale, languageService);
