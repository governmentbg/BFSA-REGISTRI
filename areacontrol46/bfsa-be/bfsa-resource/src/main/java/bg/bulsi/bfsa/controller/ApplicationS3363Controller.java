...
import bg.bulsi.bfsa.service.ApplicationS3363Service;
...
@Slf4j
@RestController
@RequestMapping("/s3363-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS3363Controller {

    private final ApplicationS3363Service service;
    ...
    public ResponseEntity<?> register(@RequestBody final ApplicationS3363DTO dto,
                                      @RequestHeader(HttpHeaders.ACCEPT_LANGUAGE) final Locale locale) {
        Language language = LocaleUtil.getLanguage(locale, languageService);
