...
import bg.bulsi.bfsa.service.ApplicationS3182Service;
...
@Slf4j
@RestController
@RequestMapping("/s3182-applications")
@SecurityRequirement(name = "bfsaapi")
@RequiredArgsConstructor(access = AccessLevel.PACKAGE)
public class ApplicationS3182Controller {

    private final ApplicationS3182Service service;
    ...
    public ResponseEntity<?> register(@RequestBody final ApplicationS3182DTO dto,
                                      @RequestHeader(HttpHeaders.ACCEPT_LANGUAGE) final Locale locale) {
        Language language = LocaleUtil.getLanguage(locale, languageService);
