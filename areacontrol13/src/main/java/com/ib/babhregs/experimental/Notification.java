...
import com.ib.babhregs.db.dto.NotificationPatternVariables;
...
public class Notification {
	...
	private String  getAttr(String attr, Integer codeClassif) {
		...
		try {
			...
			if (tekClass instanceof Integer && codeClassif != null) {
				return sd.decodeItem(codeClassif, (Integer)tekClass, BabhConstants.CODE_DEFAULT_LANG, new Date());
			}
	...
	public void generateNotif() throws DbErrorException {
		...
		if (mess.getIdObject() == null && procId != null) {
			mess.setCodeObject(BabhConstants.CODE_ZNACHENIE_JOURNAL_PROC_EXE);
