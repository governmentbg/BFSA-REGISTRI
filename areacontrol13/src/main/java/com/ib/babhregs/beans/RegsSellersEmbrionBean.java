...
@Named
@ViewScoped
public class RegsSellersEmbrionBean extends IndexUIbean   {

	/**
	 * Регистър на търговците на зародишни продукти
	 */
	...
	void initData() {
		...
		try {
			regsList=new LazyDataModelSQL2Array(publicRegisterDAO.getRegisterAsList(74),"date_licenz desc");
