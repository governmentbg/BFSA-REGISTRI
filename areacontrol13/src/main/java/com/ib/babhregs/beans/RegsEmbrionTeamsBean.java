 ...
 */
public class RegsEmbrionTeamsBean extends IndexUIbean   {

	
	private static final Logger LOGGER = LoggerFactory.getLogger(RegsEmbrionTeamsBean.class);
	private static final long serialVersionUID = 1755485238068377347L;
	...
	void initData() {
		...
		try {
			regsList=new LazyDataModelSQL2Array(publicRegisterDAO.getRegisterAsList(13),"date_licenz desc");
	...
	public void postProcessXLS(Object document) {
		...
		String title = getMessageResourceString(LABELS, "regsEmbrionTeams.title");		  
