...
@Named
@ViewScoped
public class RegsApprovedSellersBean  extends IndexUIbean   {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(RegsApprovedSellersBean.class);
	...
	void initData() {
		...
		try {
			...
			regsList=new LazyDataModelSQL2Array(publicRegisterDAO.getRegisterAsList(31),"vid_dein desc");
		} catch (Exception e) {
	...
	public void postProcessXLS(Object document) {
		...
		String title = getMessageResourceString(LABELS, "regsApprovedSellers.title");		  
