...
@Named
@ViewScoped
public class RegsMeropriatiaBean   extends IndexUIbean   {



	/**
	 * Регистър на мероприятията с животни
	 */
	private static final long serialVersionUID = 4619778318282285592L;
	private static final Logger LOGGER = LoggerFactory.getLogger(RegsMeropriatiaBean.class);
	...
	void initData() {
		...
		try {
			regsList=new LazyDataModelSQL2Array(publicRegisterDAO.getRegisterAsList(15), null);
	...
	public void postProcessXLS(Object document) {
		...
		String title = getMessageResourceString(LABELS, "regsMeropriatia.title");		  
