 ...
 */
public class RegsListMpsSJP extends IndexUIbean {


	private static final long serialVersionUID = 1121816114963698705L;
	private static final Logger LOGGER = LoggerFactory.getLogger(RegsListMpsSJP.class);
	...
	void initData() {
		...
		try {
			System.out.println("RegsListMpsSJP");
			regsList = new LazyDataModelSQL2Array(publicRegisterDAO.getRegisterAsList(43), " date_licenz desc ");
	...
	public void postProcessXLS(Object document) {
		...
		String title = getMessageResourceString(LABELS, "regsListMpsSJP.title");
