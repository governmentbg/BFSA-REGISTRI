...
/**
 *   Регистър на оператори, внасящи фуражи от трети държави по чл. 9 от Закона за фуражите idReg=35
 *   Регистър на оператори, внасящи фуражи от трети държави по чл. 10 от Закона за фуражите idReg=36
 * @author yoni
 */
@Named
@ViewScoped
public class RegsImportThirdCountries   extends IndexUIbean   {

	private static final long serialVersionUID = -8683146982595382801L;
	private static final Logger LOGGER = LoggerFactory.getLogger(RegsImportThirdCountries.class);

	private LazyDataModelSQL2Array regsList;
	PublicRegisterDAO publicRegisterDAO = new PublicRegisterDAO();
	private String title="";
	private String pageTitle="";
	private String [] titles= {"regsImportThirdCountries1.title","regsImportThirdCountries2.title"};
