 ...
 */
public class RegsSellAnimalsAbroadBean extends IndexUIbean {
	...
	void initData() {
		...
		try {
			regsList = new LazyDataModelSQL2Array(publicRegisterDAO.getRegisterAsList(20), "date_licenz desc");
	...
	public void postProcessXLS(Object document) {
		...
		String title = getMessageResourceString(LABELS, "regsSellAnimalsAbroad.title");
