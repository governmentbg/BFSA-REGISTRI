...
@Named
@ViewScoped
public class CorrespListSpr  extends IndexUIbean  implements Serializable {
	
	/**
	 * Търсене на лица за справка
	 * 
	 */
	private static final long serialVersionUID = -4003583586430983864L;
	private static final Logger LOGGER = LoggerFactory.getLogger(CorrespListSpr.class);
