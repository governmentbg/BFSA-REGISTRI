...
@Named
@ViewScoped
public class RegsSellersAnimBean  extends IndexUIbean   {

	/**
	 * Регистър на търговците на животни
	 */
	private static final long serialVersionUID = 1574880756078348004L;
	private static final Logger LOGGER = LoggerFactory.getLogger(RegsSellersAnimBean.class);
	...
	void initData() {
		...
		try {
			regsList=new LazyDataModelSQL2Array(publicRegisterDAO.getRegisterAsList(5),"date_licenz desc");
