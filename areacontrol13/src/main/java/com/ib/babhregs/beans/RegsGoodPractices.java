 ...
 */
public class RegsGoodPractices extends IndexUIbean {



	private static final long serialVersionUID = -3194526074463912522L;
	private static final Logger LOGGER = LoggerFactory.getLogger(RegsGoodPractices.class);
	...
	void initData() {
		...
		try {
			...
			regsList = new LazyDataModelSQL2Array(publicRegisterDAO.getRegisterAsList(124), " date_licenz desc ");
	...
	public void postProcessXLS(Object document) {
		...
		String title = getMessageResourceString(LABELS, "regsGoodPractices.title");
