...
@Named
@ViewScoped
public class Reg48 extends IndexUIbean   {

	/**
	 * Регистър на ферми за развъдни стада птици
	 */
	...
	void initData() {
		...
		try {
			regsList=new LazyDataModelSQL2Array(publicRegisterDAO.getRegisterAsList(47),"date_licenz desc");
