...
@Named
@ViewScoped
public class Reg30  extends IndexUIbean   {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(Reg30.class);
	...
	void initData() {
		...
		setTitleReg("/pages/reg"+idRegString+".xhtml");
