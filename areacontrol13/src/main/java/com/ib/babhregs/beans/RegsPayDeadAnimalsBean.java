...
/**
 * Регистър на заявленията за изплащане на обезщетения на собствениците на убити
 * или унищожени животни
 */
public class RegsPayDeadAnimalsBean extends IndexUIbean {

	


	private static final long serialVersionUID = -73291515607769594L;
	private static final Logger LOGGER = LoggerFactory.getLogger(RegsPayDeadAnimalsBean.class);
	...
	void initData() {
		...
		try {
			regsList = new LazyDataModelSQL2Array(publicRegisterDAO.getRegisterAsList(19), "date_licenz desc");
	...
	public void postProcessXLS(Object document) {
		...
		String title = getMessageResourceString(LABELS, "regsPayDeadAnimals.title");
