 ...
 */
public class RegsObjectsSJP extends IndexUIbean {


	private static final long serialVersionUID = -4953570627576436698L;
	private static final Logger LOGGER = LoggerFactory.getLogger(RegsObjectsSJP.class);
	...
	void initData() {
		...
		try {
			...
			regsList = new LazyDataModelSQL2Array(publicRegisterDAO.getRegisterAsList(44), " date_licenz desc ");
	...
	public void postProcessXLS(Object document) {
		...
		String title = getMessageResourceString(LABELS, "regsObjectsSJP.title");
