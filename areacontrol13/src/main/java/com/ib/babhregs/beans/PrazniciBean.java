...
import com.ib.babhregs.db.dao.PrazniciDAO;
...
public class PrazniciBean  extends IndexUIbean implements Serializable {
	...
	private static final long serialVersionUID = -1468383681612146278L;
	...
	public void onDateSelect(SelectEvent<Date> event) {
	    ...
	    yearStr = sdf.format(event.getObject());
	...
	public boolean compareDates(Date d1, Date d2) {
		...
		//проверяваме дали сравняваме дати от една година
		// set a format only for the year
	    SimpleDateFormat sdf1 = new SimpleDateFormat("yyyy");

	    // format the date; the result is the year
	    int year1=Integer.valueOf(sdf1.format(d1));
	    int year2=Integer.valueOf(sdf1.format(d2));
	    //"Сравняваме дати от различни години"
	    if(year1!=year2) {
	    	return true;
	    }
