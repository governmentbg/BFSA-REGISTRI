 ...
 */
public class RegsMPSAnimals extends IndexUIbean {

	private static final Logger LOGGER = LoggerFactory.getLogger(RegsMPSAnimals.class);
	private static final long serialVersionUID = 8924922867681657846L;
	...
	void initData() {
		try {
			regsList = new LazyDataModelSQL2Array(publicRegisterDAO.getRegisterAsList(-8), "date_licenz desc");
		} catch (Exception e) {
	...
	public void postProcessXLS(Object document) {
		...
		String title = getMessageResourceString(LABELS, "regsMPSAnimals.title");
