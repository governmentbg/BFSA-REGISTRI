...
import com.ib.babhregs.search.ExtendedUserSearch;
...
public class ExtendedUserList extends UserList {
	...
	protected void initData() {
		...
		try {
			...
			this.registraturaItemList = createItemsList(false, BabhConstants.CODE_CLASSIF_REGISTRATURI, getCurrentDate(), null);
