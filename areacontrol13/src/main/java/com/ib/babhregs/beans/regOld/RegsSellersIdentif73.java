...
@Named
@ViewScoped
public class RegsSellersIdentif73 extends IndexUIbean   {

	/**
	 * Регистър на търговците на животни
	 */
	private static final long serialVersionUID = 1574880756078348004L;
	private static final Logger LOGGER = LoggerFactory.getLogger(RegsSellersIdentif73.class);
	...
	void initData() {
		...
		try {
			regsList=new LazyDataModelSQL2Array(publicRegisterDAO.getRegisterAsList(73),"date_licenz desc");
