...
public class ProcExe extends TrackableEntity implements AuditExt {
	...
	@JournalAttr(label = "defId", defaultText = "Дефиниция", classifID = "" + BabhConstants.CODE_CLASSIF_PROCEDURI)
	...
	@JournalAttr(label = "docId", defaultText = "Инициращ документ", codeObject = BabhConstants.CODE_ZNACHENIE_JOURNAL_DOC)
	@Column(name = "DOC_ID")
	private Integer docId;

	@JournalAttr(label = "status", defaultText = "Статус", classifID = "" + BabhConstants.CODE_CLASSIF_PROC_STAT)
	@Column(name = "STATUS")
	...
	@JournalAttr(label = "beginDate", defaultText = "Начало", dateMask = "dd.MM.yyyy HH:mm")
	@Column(name = "BEGIN_DATE")
	private Date beginDate;

	@JournalAttr(label = "endDate", defaultText = "Край", dateMask = "dd.MM.yyyy HH:mm")
