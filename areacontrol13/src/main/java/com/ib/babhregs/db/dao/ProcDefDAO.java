...
import static com.ib.babhregs.system.BabhConstants.CODE_ZNACHENIE_PROC_DEF_STAT_DEV;
import static com.ib.babhregs.system.BabhConstants.CODE_ZNACHENIE_PROC_STAT_EXE;
import static com.ib.babhregs.system.BabhConstants.CODE_ZNACHENIE_PROC_STAT_WAIT;
...
public class ProcDefDAO extends AbstractDAO<ProcDef> {
	...
	public ProcDef copyProcDef(Integer sourceDefId, String newName, Integer registraturaId, BaseSystemData systemData) throws DbErrorException, ObjectInUseException {
		...
		List<Files> files = filesDao.selectByFileObject(sourceDefId, BabhConstants.CODE_ZNACHENIE_JOURNAL_PROC_DEF);
		for (Files f : files) {
			filesDao.saveFileObject(f, copy.getId(), BabhConstants.CODE_ZNACHENIE_JOURNAL_PROC_DEF);
		}
