...
public class ReferentAddress extends TrackableEntity implements Cloneable {
	/**  */
	...
	@JournalAttr(label = "missing.addrText", defaultText = "Адрес на английски")
	@Column(name = "ADDR_TEXT_LATIN")
	private String addrTextLatin;
	...
	@Override
	protected ReferentAddress clone() throws CloneNotSupportedException {
		return (ReferentAddress) super.clone();
	}
	...
	public String getAddrTextLatin() {
		return addrTextLatin;
	}

	public void setAddrTextLatin(String addrTextLatin) {
		this.addrTextLatin = addrTextLatin;
	}
}