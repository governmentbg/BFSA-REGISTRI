...
//	@JournalAttr(label = "registraturaId", defaultText = "ИД на регистратура")
	...
	@JournalAttr(label = "register.tipReg", defaultText = "Тип регистър", classifID = "" + BabhConstants.CODE_CLASSIF_REGISTER_TYPE)
	...
	@JournalAttr(label = "register.tipDoc", defaultText = "Тип документ", classifID = "" + BabhConstants.CODE_CLASSIF_DOC_TYPE)
	...
	@JournalAttr(label = "register.alg", defaultText = "Алгоритъм", classifID = "" + BabhConstants.CODE_CLASSIF_ALG)
	@Column(name = "ALG")
	private Integer alg;
	...
	public Integer getCodeMainObject() {
		return BabhConstants.CODE_ZNACHENIE_JOURNAL_REGISTER;
	}
