...
public class RegistraturaGroup extends TrackableEntity implements AuditExt {
	...
	@JournalAttr(label = "groupType", defaultText = "Тип на групата", classifID = "" + BabhConstants.CODE_CLASSIF_REGISTRATURA_GROUP_TYPE)
	...
	public Integer getCodeMainObject() {
		return BabhConstants.CODE_ZNACHENIE_JOURNAL_REISTRATURA_GROUP;
	}
	...
	public String getIdentInfo() throws DbErrorException {
		...
		if (this.groupType.equals(BabhConstants.CODE_ZNACHENIE_REG_GROUP_TYPE_EMPL)) {
