...
import static com.ib.babhregs.system.BabhConstants.CODE_ZNACHENIE_DOC_TYPE_WRK;
...
public class RegisterDAO extends AbstractDAO<Register> {
	...
	public void delete(Integer contextRegistratura, Register entity, BaseSystemData sd) throws DbErrorException, ObjectInUseException {
		try {
			...
			// ADM_USER_ROLES.CODE_ROLE (CODE_CLASSIF=BabhConstants.CODE_CLASSIF_REGISTRI)
	...
	@SuppressWarnings("unchecked")
	public List<Object[]> useRegister(Integer registerId) throws DbErrorException {
		
		if (registerId == null)  return null;
		
		try { 
			
			String sql = " SELECT 58 JOURNAL_CODE, REGISTRATURA_ID, DOC_VID " + 
						 " FROM DOC_VID_SETTINGS " + 
