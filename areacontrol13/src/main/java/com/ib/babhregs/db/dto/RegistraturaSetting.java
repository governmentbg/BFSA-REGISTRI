...
//	@JournalAttr(label = "registraturaId", defaultText = "ИД на регистратура")
	...
	@JournalAttr(label = "regSettings.setting", defaultText = "Настройка", classifID = "" + BabhConstants.CODE_CLASSIF_REISTRATURA_SETTINGS)
	...
	public Integer getCodeMainObject() {
		return BabhConstants.CODE_ZNACHENIE_JOURNAL_REISTRATURA_SETT;
	}
