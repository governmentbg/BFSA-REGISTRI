...
public class ProcExeEtap extends TrackableEntity implements AuditExt {
	...
	@JournalAttr(label = "status", defaultText = "Статус", classifID = "" + BabhConstants.CODE_CLASSIF_ETAP_STAT)
	@Column(name = "STATUS")
	...
	@JournalAttr(label = "docId", defaultText = "Стартиращ документ", codeObject = BabhConstants.CODE_ZNACHENIE_JOURNAL_DOC)
	@Column(name = "DOC_ID")
...
//	[0]-defEtapId; [1]-isMerge
	...
	public Integer getCodeMainObject() {
		return BabhConstants.CODE_ZNACHENIE_JOURNAL_PROC_EXE_ETAP;
	}
	...
	public SystemJournal toSystemJournal() throws DbErrorException {
		...
		journal.setJoinedCodeObject1(BabhConstants.CODE_ZNACHENIE_JOURNAL_PROC_EXE);
