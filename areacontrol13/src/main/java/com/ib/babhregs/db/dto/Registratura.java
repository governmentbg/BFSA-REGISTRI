...
public class Registratura extends TrackableEntity implements AuditExt {
	...
	@JournalAttr(label = "registratura_lat", defaultText = "Наименование на регистратура (лат.)")
	@Column(name = "registratura_lat")
	private String registraturaLat; // (varchar(100))

	@JournalAttr(label = "org_name_lat", defaultText = "Наименование на организация (лат.)")
	@Column(name = "org_name_lat")
	private String orgNameLat; // (varchar(255))

	@JournalAttr(label = "contact_phone", defaultText = "Телефон")
	@Column(name = "contact_phone")
	private String contactPhone; // (varchar(100))

	@JournalAttr(label = "contact_email", defaultText = "Електронна поща")
	@Column(name = "contact_email")
	private String contactEmail; // (varchar(100))

	@JournalAttr(label = "contact_fax", defaultText = "Факс")
	@Column(name = "contact_fax")
	private String contactFax; // (varchar(100))
	...
	public Integer getCodeMainObject() {
		return BabhConstants.CODE_ZNACHENIE_JOURNAL_REISTRATURA;
	}
	...
	/** @return the orgNameLat */
	public String getOrgNameLat() {
		return this.orgNameLat;
	}
	...
	/** @return the registraturaLat */
	public String getRegistraturaLat() {
		return this.registraturaLat;
	}
	...
	/** @param orgNameLat the orgNameLat to set */
	public void setOrgNameLat(String orgNameLat) {
		this.orgNameLat = orgNameLat;
	}
	...
	/** @param registraturaLat the registraturaLat to set */
	public void setRegistraturaLat(String registraturaLat) {
		this.registraturaLat = registraturaLat;
	}
