...
public class ProcDefEtap extends TrackableEntity implements AuditExt {
	...
	@JournalAttr(label = "etapDocMode", defaultText = "Тип стартиращ документ", classifID = "" + BabhConstants.CODE_CLASSIF_ETAP_DOC_MODE)
	private Integer etapDocMode;

	@Column(name = "extend_proc_srok")
	@JournalAttr(label = "extend_proc_srok", defaultText = "Удължава общия срок на процедурата", classifID = "" + SysConstants.CODE_CLASSIF_DANE)
	private Integer extendProcSrok;
...
//	[0]-id; [1]-nomer; [2]-etapName
	...
	public Integer getCodeMainObject() {
		return BabhConstants.CODE_ZNACHENIE_JOURNAL_PROC_DEF_ETAP;
	}
	...
	/** @return the extendProcSrok */
	public Integer getExtendProcSrok() {
		return this.extendProcSrok;
	}
	/** @param extendProcSrok the extendProcSrok to set */
	public void setExtendProcSrok(Integer extendProcSrok) {
		this.extendProcSrok = extendProcSrok;
	}
	...
	public SystemJournal toSystemJournal() throws DbErrorException {
		...
		dj.setJoinedCodeObject1(BabhConstants.CODE_ZNACHENIE_JOURNAL_PROC_DEF);
