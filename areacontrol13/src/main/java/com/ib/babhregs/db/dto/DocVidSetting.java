...
//	@JournalAttr(label = "registraturaId", defaultText = "ИД на регистратура")
	...
	@JournalAttr(label = "docVidSetting.typeDoc", defaultText = "Вид документ", classifID = "" + BabhConstants.CODE_CLASSIF_DOC_VID)
	@Column(name = "DOC_VID")
	private Integer docVid;

	@JournalAttr(label = "docu.register", defaultText = "Регистър", classifID = "" + BabhConstants.CODE_CLASSIF_REGISTRI)
	...
	@JournalAttr(label = "missing.procDefIn", defaultText = "Стартира процедура: за входящ документ", classifID = "" + BabhConstants.CODE_CLASSIF_PROCEDURI)
	@Column(name = "PROC_DEF_IN")
	private Integer procDefIn;

	@JournalAttr(label = "missing.procDefOwn", defaultText = "Стартира процедура: за собствен документ", classifID = "" + BabhConstants.CODE_CLASSIF_PROCEDURI)
	@Column(name = "PROC_DEF_OWN")
	private Integer procDefOwn;

	@JournalAttr(label = "missing.procDefWork", defaultText = "Стартира процедура: за работен документ", classifID = "" + BabhConstants.CODE_CLASSIF_PROCEDURI)
	@Column(name = "PROC_DEF_WORK")
	private Integer procDefWork;

	@JournalAttr(label = "docVidSettings.characterSpecDoc", defaultText = "Характер на специализиран документ", classifID = "" + BabhConstants.CODE_CLASSIF_CHARACTER_SPEC_DOC)
	@Column(name = "DOC_HAR")
	...
	public Integer getCodeMainObject() {
		return BabhConstants.CODE_ZNACHENIE_JOURNAL_DOC_VID_SETT;
	}
