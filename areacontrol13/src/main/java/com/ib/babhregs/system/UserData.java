...
import static com.ib.babhregs.system.BabhConstants.CODE_ZNACHENIE_NOTIFF_EVENTS_UNAUTHORIZED_PAGE;
...
public class UserData extends BaseUserData {
	...
	/**
	 * ако логнатия е с ръководна длъжност {@link BabhConstants#CODE_CLASSIF_BOSS_POSITIONS}, то тука ще влезнат списък на звената
	...
	/** няма достъп до области на контрол */
	private boolean limitedAccess = true;
